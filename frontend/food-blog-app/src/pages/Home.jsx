    ...
    return (
        <>
            <section className='home'>
                <div className='left'>
                    <h1>Food Recipe</h1>
                    <h4>Discover delicious recipes from everyday cooks and passionate food lovers. Whether you're craving something quick or planning a special meal, find the perfect dish here.</h4>
                    <button onClick={addRecipe} className='share-btn'>Share your recipe</button>
                </div>
                <div className='right'>
